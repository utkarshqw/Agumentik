import { Box, Button, Flex, HStack, Img, Input, Modal, ModalBody, ModalContent, ModalHeader, ModalOverlay, Select, Text, useDisclosure, useToast, VStack } from "@chakra-ui/react";
...
const Navbar = () => {
  ...
  const [init, setinit] = useState({email:"admin@email.com",password:"1234"})
  ...
  return (
    ...
    >
     ...
     >
      ...
      <Button onClick={()=>onOpen()} fontSize={"14px"} _hover={{bg:"none", color:"orange"}} variant={"ghost"}>Admin</Button>
      </Flex>
    </Flex>
    ...
    <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalBody>
            <VStack>
            <Input placeholder="username" value={init.email}   name="email" onChange={handleChange} />
            <Input placeholder="password" value={init.password} name="password" onChange={handleChange} />
            </VStack>
